...
describe('Atom <AboutInfo />', function () {
  ...
  it('Calls componentDidMount', () => {
    const mockDidMount = sinon.spy(AboutInfo.prototype, 'componentDidMount');
  ...
  it('Correct types', () => {
    ...
    expect(this.wrapper.get(0).props.children[0].type).to.eql('p');
    expect(this.wrapper.get(0).props.children[1].type).to.eql('p');
    expect(this.wrapper.get(0).props.children[2].type).to.eql('p');

    expect(this.wrapper.find('div').exists()).to.eql(true);
    expect(this.wrapper.find('p').exists()).to.eql(true);

    expect(this.wrapper.find('div')).to.have.length(1);
    expect(this.wrapper.find('p')).to.have.length(3);
  });

  it('Correct props', () => {
    expect(this.wrapper.find('p').get(0).props.children).to.eql(this.correctAboutInfo1);
    expect(this.wrapper.find('p').get(1).props.children).to.eql(this.correctAboutInfo2);
    expect(this.wrapper.find('p').get(2).props.children).to.eql(this.correctAboutInfo3);
  });
